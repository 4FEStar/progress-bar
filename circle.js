(function() {
    ...
    Circle.prototype.drawId = undefined
    Circle.prototype.draw = function(current) {
        if (Number(current) >= 0) {
    ...
    Circle.prototype.restart = function() {
        this._shadow_current = 0
        this.draw()
    }


    Circle.prototype.drawBackground = function () {
        this.ctx.beginPath()
    ...
    Circle.prototype.roundRect = function(x, y, width, height, radius, fill, stroke) {  
        var radius = radius || 5;
        this.ctx.beginPath();
